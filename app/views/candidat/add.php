                ...
                <div class="col-xs-12 col-md-8">
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-12 col-md-6 form-group row mb-3">
                            ...
                            <div class="col-lg-8">
                                ...
                                type="text" id="prenom" name="prenom" placeholder="prenom"/>
                    ...
                    <div class="row mb-3">
                        <div class="col-xs-12 col-md-6 form-group row mb-3">
                            ...
                            <div class="col-lg-8">
                                <input class="form-control-sm form-control <?= (!empty($data['body_err']['cin_err'])) ? 'is-invalid' : ''; ?>" 
                                value="<?= (!empty($data['body']['cin'])) ? $data['body']['cin'] : ''; ?>" 
                                type="text" id="cin" name="cin" placeholder="CIN"/>
                        ...
                        <div class="col-xs-12 col-md-6 form-group row mb-3">
                            ...
                            <div class="col-lg-8">
                                ...
                                value="<?= (!empty($data['body']['phone'])) ? $data['body']['phone'] : ''; ?>" 
                                type="text" id="phone" name="phone" placeholder="Télephone"/>
                    ...
                    <div class="row">
                        <div class="col-xs-12 col-md-6 form-group row mb-3">
                            ...
                            <div class="col-lg-7">
                                <input type="date" class="form-control-sm form-control <?= (!empty($data['body_err']['datenaiss_err'])) ? 'is-invalid' : ''; ?>" 
                                value="<?= (!empty($data['body']['datenaiss'])) ? $data['body']['datenaiss'] : ''; ?>" 
                                id="datenaiss" name="datenaiss" placeholder="999/99/9999" />
                        ...
                        <div class="col-xs-12 col-md-6 form-group row mb-3">
                            ...
                            <div class="col-lg-7">
                                <input class="form-control-sm form-control <?= (!empty($data['body_err']['lieuNais_err'])) ? 'is-invalid' : ''; ?>" 
                                value="<?= (!empty($data['body']['lieuNais'])) ? $data['body']['lieuNais'] : ''; ?>" 
                                type="text" id="lieuNais" name="lieuNais" placeholder="Lieu naissance"/>
                    ...
                    <div class="row">
                        <div class="col-xs-12 col-md-6 form-group row mb-3">
                            ...
                            <div class="col-lg-8">
                                <input class="form-control-sm form-control <?= (!empty($data['body_err']['prix_err'])) ? 'is-invalid' : ''; ?>" 
                                value="<?= (!empty($data['body']['prix'])) ? $data['body']['prix'] : ''; ?>" 
                                type="number" min="0" max="20000" id="prix" name="prix" placeholder="Prix"/>
                        ...
                        <div class="col-xs-12 col-md-6 form-group row mb-3">
                            ...
                            <div class="col-lg-8">
                                <input class="form-control-sm form-control <?= (!empty($data['body_err']['reste_err'])) ? 'is-invalid' : ''; ?>" 
                                value="<?= (!empty($data['body']['reste'])) ? $data['body']['reste'] : ''; ?>" 
                                type="number" min="0" max="20000" id="reste" name="reste" placeholder="Reste"/>
                    ...
                    <div class="row">
                        <div class="col-xs-12 col-md-6 form-group row mb-3">
                            ...
                            <div class="col-lg-6">
                                <input type="date" class="form-control-sm form-control <?= (!empty($data['body_err']['dateDebutTher_err'])) ? 'is-invalid' : ''; ?>" 
                                value="<?= (!empty($data['body']['dateDebutTher'])) ? $data['body']['dateDebutTher'] : ''; ?>" 
                                name="dateDebutTher" id="dateDebutTher" placeholder="999/99/9999" />
                        ...
                        <div class="col-xs-12 col-md-6 form-group row mb-3">
                            ...
                            <div class="col-lg-6">
                                <input class="form-control-sm form-control <?= (!empty($data['body_err']['nbrHeurThe_err'])) ? 'is-invalid' : ''; ?>" 
                                value="<?= (!empty($data['body']['nbrHeurThe'])) ? $data['body']['nbrHeurThe'] : ''; ?>" 
                                type="number" min="10" max="60" id="nbrHeurThe" name="nbrHeurThe" placeholder="30"/>
                    ...
                    <div class="row">
                        <div class="col-xs-12 col-md-6 form-group row mb-3">
                            ...
                            <div class="col-lg-6">
                                <input type="date" class="form-control-sm form-control <?= (!empty($data['body_err']['dateDebutPra_err'])) ? 'is-invalid' : ''; ?>" 
                                value="<?= (!empty($data['body']['dateDebutPra'])) ? $data['body']['dateDebutPra'] : ''; ?>" 
                                name="dateDebutPra" id="dateDebutPra" placeholder="999/99/9999" />
                        ...
                        <div class="col-xs-12 col-md-6 form-group row mb-3">
                            ...
                            <div class="col-lg-6">
                                <input class="form-control-sm form-control <?= (!empty($data['body_err']['nbrHeurPra_err'])) ? 'is-invalid' : ''; ?>" 
                                value="<?= (!empty($data['body']['nbrHeurPra'])) ? $data['body']['nbrHeurPra'] : ''; ?>" 
                                type="number" min="10" max="60" id="nbrHeurPra" name="nbrHeurPra" placeholder="20"/>
                    ...
                    <div class="row">
                        <div class="col-xs-12 col-md-6 form-group row mb-3">
                            <label class="form-label col-form-label col-lg-6" for="categorie">catégorie <sup>*</sup>:</label>
                            <div class="col-lg-6">
                                <select class="form-select form-control <?= (!empty($data['body_err']['categorie_err'])) ? 'is-invalid' : ''; ?>" 
                                name="categorie">
                                    <option></option>
                                    <?php foreach($data['permis'] as $cat) :?>
                                    <option value="<?= $cat['id'] ?>" 
                                        <?= (!empty($data['body']['categorie'])) ? 'selected' : ''; ?>> 
                                        <?= $cat['Categorie'] ?>
                                    </option>
                                    <?php endforeach ?>
                                </select>
                        ...
                        <div class="col-xs-12 col-md-6 form-group row mb-3">
                            ...
                            <div class="col-lg-6">
                                <input class="form-control-sm form-control <?= (!empty($data['body_err']['numSite_err'])) ? 'is-invalid' : ''; ?>" 
                                value="<?= (!empty($data['body']['numSite'])) ? $data['body']['numSite'] : ''; ?>"
                                type="text" min="0" id="numSite" name="numSite" placeholder=""/>
                    ...
                    <div class="row">
                        <div class="col-xs-12 col-md-6 form-group row mb-3">
                            ...
                            <div class="col-lg-6">
                                <input type="text" class="form-control-sm form-control <?= (!empty($data['body_err']['numContrat_err'])) ? 'is-invalid' : ''; ?>" 
                                value="<?= (!empty($data['body']['numContrat'])) ? $data['body']['numContrat'] : ''; ?>" 
                                id="masked-input-ssn" placeholder="" name="numContrat" />
                        ...
                        <div class="col-xs-12 col-md-6 form-group row mb-3">
                            ...
                            <div class="col-lg-6">
                                <input type="date" class="form-control-sm form-control <?= (!empty($data['body_err']['dateContrat_err'])) ? 'is-invalid' : ''; ?>" 
                                value="<?= (!empty($data['body']['dateContrat'])) ? $data['body']['dateContrat'] : ''; ?>" 
                                name="dateContrat" id="dateContrat" placeholder="999/99/9999" />
                    ...
                    <div class="row text-nowrap">
                        <div class="col-xs-12 col-md-6 form-group row mb-3">
                            ...
                            <div class="col-lg-6">
                                <input type="date" class="form-control-sm form-control <?= (!empty($data['body_err']['dateExamen1_err'])) ? 'is-invalid' : ''; ?>" 
                                value="<?= (!empty($data['body']['dateExamen1'])) ? $data['body']['dateExamen1'] : ''; ?>" 
                                id="dateExamen1" name="dateExamen1" placeholder="999/99/9999" />
